...
public class dataProvide {
	...
	DataFormatter formatter = new DataFormatter();//it is used to convert any sort of value int, boolean into string
//	@Test(dataProvider = "driveTest")
//	public void testCaseData(String NameOfBots, String Urls)
//	{
//		System.out.println(Urls);
//	}
	
	@Test (dataProvider = "driveTest")
	public void Main(String NameOfBots, String Urls) {
	...
	{
		//mentioning the file exact location
		...
		for(int i=0;i<rowCount-1; i++) 
		{
			...
			for (int j=0;j<colCount;j++) 
			{
				...
				XSSFCell cell = row.getCell(j); //in the outer loop, i iterates through each row and in the inner loop j iterates through each cell in the row where i is present
				Data [i][j]= formatter.formatCellValue(cell);//formatter is a variable of DataFormatter of apache POI which is used to convert any value into string
			}
		}
		return Data;	
	}
